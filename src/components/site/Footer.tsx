...
const social = [
  ...
  { href: "mailto:hello@adrianvale.dev", label: "Email", Icon: Mail },
];
    ...
    <footer className="border-t border-border/60 bg-surface/60">
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li><Link to="/experience" className="text-foreground/80 hover:text-foreground">Experience</Link></li>
        ...
        <div className="mt-16 flex flex-col items-start justify-between gap-4 border-t border-border/60 pt-8 text-xs text-muted-foreground md:flex-row md:items-center">
          <p>© {new Date().getFullYear()} Adrian Vale. Designed and built with care.</p>
          <p>Made on iPhone, MacBook, and a lot of espresso.</p>
        </div>
      </div>
    </footer>
  );
