...
export function AppCard({
  ...
  return (
    <motion.article
      ...
      viewport={{ once: true, margin: "-100px" }}
      transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}
      className="relative overflow-hidden rounded-3xl border border-border/70 bg-card shadow-sm dark:border-white/[0.08] dark:bg-white/[0.035] dark:shadow-black/20"
    >
        ...
        >
          <div className="flex items-center gap-3">
            <img
              ...
              height={48}
              loading="lazy"
              className="h-12 w-12 rounded-[12px] object-cover shadow-md"
            />
